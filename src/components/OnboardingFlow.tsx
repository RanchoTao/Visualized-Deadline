        ...
        {step === 3 ? (
          <div>
            ...
            <div className="mt-8 flex justify-between gap-3">
              ...
              <button type="button" onClick={completeOnboarding} className="rounded-full bg-slate-950 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-slate-700">进入飞升</button>
            </div>
          </div>
        ) : null}
      </section>
